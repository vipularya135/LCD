...
def main():
    ...
    # Prepare data (choose one of the three datasets: 'svhn' or 'cifar10' or 'cifar100' or 'voc2012'. I have choosen SVHN dataset)
    initial_train_set, remainder, test_set = prepare_data("voc2012") 
